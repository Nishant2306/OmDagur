...
export const SOCIALS = [
  ...
  { label: "Book a Show", icon: "🎫", url: "#book", color: "#FFD700", external: false },
];
...
/* maxres is often missing for Shorts; hqdefault always exists. */
export const thumbUrl = (item, big = true) =>
  `https://img.youtube.com/vi/${item.embedId}/${big && item.kind === "video" ? "maxresdefault" : "hqdefault"}.jpg`;
